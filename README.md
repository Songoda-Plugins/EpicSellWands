...
> **[Official EpicSellWands website][Plugin page]**
>
...
EpicSellWands is a Minecraft item-selling server plugin developed and maintained by
**Songoda Reborn**.

It lets players sell stored loot with configurable sell wands through an in-game
workflow designed for server economies.
...
## Documentation
The [EpicSellWands wiki][Plugin wiki] is maintained by Songoda Reborn and covers
installation, configuration, commands, permissions, dependencies, and compatibility.

## Support
For help with EpicSellWands, join our [Discord server][Discord invite].

## Suggestions
Share feature suggestions and feedback through our [Discord server][Discord invite].


[Plugin page]: https://songoda-reborn.com/plugins/epicsellwands
[Plugin wiki]: https://songoda-reborn.com/plugins/epicsellwands/wiki
